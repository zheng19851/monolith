package com.runssnail.monolith.dal.router.config;
...
import com.runssnail.monolith.dal.router.DefaultRouter;
import com.runssnail.monolith.dal.router.config.vo.MonoInternalRule;
import com.runssnail.monolith.dal.router.config.vo.MonoInternalRules;
import com.runssnail.monolith.dal.router.rules.ibatis.MonoIBatisNamespaceRule;
import com.runssnail.monolith.dal.router.rules.ibatis.MonoIBatisNamespaceShardingRule;
import com.runssnail.monolith.dal.router.rules.ibatis.MonoIBatisSqlActionRule;
import com.runssnail.monolith.dal.router.rules.ibatis.MonoIBatisSqlActionShardingRule;
