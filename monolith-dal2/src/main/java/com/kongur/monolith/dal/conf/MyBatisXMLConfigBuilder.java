...
/**
 * use {@link MyBatisConfiguration} to replace {@link Configuration}
 * 
 * copy from {@link XMLConfigBuilder}
 * 
 * 
 * @author zhengwei
 *
...
public class MyBatisXMLConfigBuilder extends BaseBuilder {
    ...
    public MyBatisXMLConfigBuilder(InputStream inputStream, String environment, Properties props, DataSourceRouter router) {
        this(new XPathParser(inputStream, true, props, new XMLMapperEntityResolver()), environment, props, router);
    }

    private MyBatisXMLConfigBuilder(XPathParser parser, String environment, Properties props, DataSourceRouter router) {
        super(new MyBatisConfiguration(router)); 
