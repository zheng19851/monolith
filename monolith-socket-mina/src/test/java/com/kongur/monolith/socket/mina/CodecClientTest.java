...
public class CodecClientTest {
    ...
    private static void send(String transCode) throws Exception {
        ...
        while ((len = in.read(buffer)) != -1) {
            System.out.println("len=" + len + ", get==" + new String(buffer, Constants.DEFAULT_CHARSET));
        }
...
//        bb.putString(fixedParams, encoder);
    ...
    private static String buildDefaultHead(String transCode) {
        ...
        sb.append("01");
        sb.append(transCode);// .append(Constants.DEFAULT_SPLIT_CHAR); // 交易代码
        sb.append("000001");// 交易所编号

        sb.append("001001");// 银行代码

        sb.append("00100100100100002222");// .append(Constants.DEFAULT_SPLIT_CHAR); // 前台流水号12

        sb.append("20130822");// .append(Constants.DEFAULT_SPLIT_CHAR); // 交易日期

        sb.append("153022");// .append(Constants.DEFAULT_SPLIT_CHAR); // 交易时间

        sb.append("00000001");// .append(Constants.DEFAULT_SPLIT_CHAR); // 记录条数
    ...
    public static String build3101Head() {
        ...
        sb.append("3101");// .append(Constants.DEFAULT_SPLIT_CHAR); // 交易代码
        sb.append("000001");// .append(Constants.DEFAULT_SPLIT_CHAR); // 机构代码
        sb.append("000301");// .append(Constants.DEFAULT_SPLIT_CHAR); // 核算机构

        sb.append("001001");// .append(Constants.DEFAULT_SPLIT_CHAR); // 柜员号

        sb.append("001001001001");// .append(Constants.DEFAULT_SPLIT_CHAR); // 前台流水号12
        ...
        sb.append("filename    ");// .append(Constants.DEFAULT_SPLIT_CHAR); // 文件名
    ...
    private static String build3500Body() {
        ...
        sb.append("323232").append(Constants.DEFAULT_SPLIT_CHAR); // 交易所编号
        sb.append("100000033333"); // 银行帐号
        sb.append(Constants.DEFAULT_SPLIT_CHAR);

        sb.append("1").append(Constants.DEFAULT_SPLIT_CHAR); // 帐号类型
    ...
    private static String build3500Header() {
        ...
        sb.append("3500");// .append(Constants.DEFAULT_SPLIT_CHAR); // 交易代码
        sb.append("000001");// .append(Constants.DEFAULT_SPLIT_CHAR); // 交易所编号
        sb.append("000301");// .append(Constants.DEFAULT_SPLIT_CHAR); // 核算机构

        sb.append("001001");// .append(Constants.DEFAULT_SPLIT_CHAR); // 柜员号

        sb.append("001001");// .append(Constants.DEFAULT_SPLIT_CHAR); // 前台流水号
    ...
    private static String buildBankToExchange() {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("4444444333").append(Constants.DEFAULT_SPLIT_CHAR);
        sb.append("00000101"); // 交易帐号
        sb.append(Constants.DEFAULT_SPLIT_CHAR);
        sb.append("CNY"); // 人民币
        sb.append(Constants.DEFAULT_SPLIT_CHAR);

        sb.append("10000").append(Constants.DEFAULT_SPLIT_CHAR); // 金额
    ...
    private static String buildHeader() {
        ...
        StringBuilder sb = new StringBuilder(); // 版本号
        sb.append("01");// .append(Constants.DEFAULT_SPLIT_CHAR);
        sb.append("6200");// .append(Constants.DEFAULT_SPLIT_CHAR); // 交易代码
        sb.append("000001");// .append(Constants.DEFAULT_SPLIT_CHAR); // 交易所编号

        sb.append("001001");// .append(Constants.DEFAULT_SPLIT_CHAR); // 银行代码

        sb.append("00100193939393939443");// .append(Constants.DEFAULT_SPLIT_CHAR); // 请求方流水号
