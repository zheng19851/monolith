...
import com.runssnail.monolith.socket.buffer.ByteBuffers;
...
import com.runssnail.monolith.socket.message.codec.EnumMessageErrorCode;
import com.runssnail.monolith.socket.message.codec.MessageCodecFactory;
import com.runssnail.monolith.socket.message.codec.MessageDecoder;
...
public class DefaultProtocolParser extends AbstractProtocolParser {
    ...
    protected UpstreamMessage doParse(ByteBuffer buffer) throws CharacterCodingException {
        ...
        final CharsetDecoder decoder = com.runssnail.monolith.socket.Constants.DEFAULT_CHARSET.newDecoder();
...
//        }
        ...
        // 成功了
        UpstreamMessage um = result.getUpsteamMessage();
